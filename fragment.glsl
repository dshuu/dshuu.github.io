...
void main(){
	vec2 screenpos=(2.0*gl_FragCoord.xy-u_resolution.xy)/max(u_resolution.x,u_resolution.y);

	float focaldistance=0.5+sin(u_time*0.05)*0.013;
